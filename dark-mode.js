...
function insertDarkModeButton() {
    const buttonHTML = `
        <button id="toggleDarkMode" 
            class="fixed z-50 bottom-24  left-5 flex items-center gap-0 px-3 py-3 bg-blue-600 text-white rounded-full shadow-lg transition-all duration-300 hover:bg-blue-500">
